...
<style>
    ...
    <form action="generate_bill.php" method="POST">
                <div class="product-container">
                    <div class="image">
                        <img src="images/shoes9.png" class="product-image" alt="Product Image">
                    </div>
                    <h2 id="total-price">Price: Rs.499</h2>

                    <p>
                        <h3><b>Layasa</b> Casual Sneakers White Shoes</h3>
                    </p>
                    ...
                    <h2>
                        ...
                        <select id="qty" name="qty" class="select-box" onchange="calculatePrice()" required>
                    ...
                    <br>
                    <input type="hidden" name="price" value="499" id="hidden-price">
